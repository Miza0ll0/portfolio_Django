...
SECRET_KEY = os.environ.get('SECRET_KEY', 'dev-secret-key')  # override en prod
...
SECRET_KEY = 'django-insecure-yh9t5^*0g-!_@#n#(k0=*&==9(-&lsmj=^mu6h=h^x)l8!g1zj'
